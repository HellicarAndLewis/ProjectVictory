...
We using the _master_ branch of the [openFrameworks](https://github.com/openframeworks/openFrameworks)
...
- all application should be compilable directly after cloning the ProjectVictory repository
- all addons are stored in the ProjectVictory repository
